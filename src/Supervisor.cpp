...
Supervisor_t::~Supervisor_t() {
  ...
  if (arcade_vm_1)
    delete arcade_vm_1;
  if (arcade_vm_2__handles_upscaling)
    delete arcade_vm_2__handles_upscaling;
  if (arcade_vm_3__handles_seija)
    delete arcade_vm_3__handles_seija;
}
...
void Supervisor_t::init_cameras() {
  ...
  cameras[3].viewport.X =
      static_cast<int>((anm::BACK_BUFFER_SIZE.x - 408.0) * 0.5);
  cameras[3].viewport.Y =
      static_cast<int>((anm::BACK_BUFFER_SIZE.y - 472.0) * 0.5);
...
static int supervisor_on_draw_0f() {
  ...
  if (SUPERVISOR.arcade_vm_0->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_0->bitflags.anchorY =
        SUPERVISOR.arcade_vm_0->bitflags.anchorY % 2 + 1;
  anm::draw_vm(SUPERVISOR.arcade_vm_0);
  if (SUPERVISOR.arcade_vm_0->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_0->bitflags.anchorY =
        SUPERVISOR.arcade_vm_0->bitflags.anchorY % 2 + 1;
...
static int supervisor_on_draw_1a() {
  ...
  if (SUPERVISOR.arcade_vm_1->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_1->bitflags.anchorY =
        SUPERVISOR.arcade_vm_1->bitflags.anchorY % 2 + 1;
  anm::draw_vm(SUPERVISOR.arcade_vm_1);
  if (SUPERVISOR.arcade_vm_1->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_1->bitflags.anchorY =
        SUPERVISOR.arcade_vm_1->bitflags.anchorY % 2 + 1;
...
static int supervisor_on_draw_2d() {
  ...
  if (SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY =
        SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY % 2 + 1;
  anm::draw_vm(SUPERVISOR.arcade_vm_2__handles_upscaling);
  if (SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY =
        SUPERVISOR.arcade_vm_2__handles_upscaling->bitflags.anchorY % 2 + 1;
...
static int supervisor_on_draw_3a() {
  ...
  if (SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY =
        SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY % 2 + 1;
  anm::draw_vm(SUPERVISOR.arcade_vm_3__handles_seija);
  if (SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY != 0)
    SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY =
        SUPERVISOR.arcade_vm_3__handles_seija->bitflags.anchorY % 2 + 1;
  ...
  static int f_on_draw() {
    if ((SUPERVISOR.gamemode_to_switch_to != 0xf) &&
      ...
      if (ASCII_MANAGER_PTR) {
        ...
        ASCII_MANAGER_PTR->create_string_f({588, 470, 0}, "%2.1ffps",
                                           fps + 0.05);
...
static int supervisor_on_tick() {
  if (FPS_COUNTER_PTR)
    FPS_COUNTER_PTR->current_fps = ns::get_instance()->fps();
  return 1;
  //   void *pvVar1;
  ...
  //
  //   if (((SUPERVISOR.flags & 0x180U) == 0x80) &&
  //   ((SUPERVISOR.__thread_998).__bool_10 == 0)) {
  ...
  //       *(int *)((int)DAT_00529e88 + 0x18) = *(int *)((int)DAT_00529e88 +
  //       0x18) + -1; if (*(int *)((int)pvVar1 + 0x18) < 1) {
  //         *(undefined4 *)((int)pvVar1 + 0x20) = 0;
  //         (**(code **)(***(int ***)((int)pvVar1 + 8) + 0x48))(**(int
  //         ***)((int)pvVar1 + 8));
  //       }
  //       else {
  //         FUN_00477ca0(pvVar1,(*(int *)((int)pvVar1 + 0x18) * 5000) / *(int
  //         *)((int)pvVar1 + 0x1c) +
  //                             -5000);
  //       }
  //     }
  ...
  //       }
  //       else {
  //         FUN_00477ca0(pvVar1,(*(int *)((int)pvVar1 + 0x18) * 1000) / *(int
  //         *)((int)pvVar1 + 0x1c) +
  //                             -1000);
  //       }
  //     }
...
static int supervisor_on_registration() {
  ...
  //   SUPERVISOR.field107_0xa24 =
  //   reads_file_into_new_allocation_4020d0(str_buff,&local_8c,0);
