...
static const std::pair<int, std::string> alcostg_fmts[] = {
    { 291, "SSffS" },
    { -1, "NOFORMAT" }
};
static const std::pair<int, std::string> th11_fmts[] = {
    { 369, "S" },
    { 437, "Sff" },
    { 438, "Sf" },
    { 444, "S" },
...
static const std::pair<int, std::string> th12_fmts[] = {
    { 89, "fff" },
    { 277, "Sf" },
    { 278, "Sff" },
    { 280, "mSSSSS" },
...
static const std::pair<int, std::string> th125_fmts[] = {
    { 303, "SSfS" },
    { 306, "fS" },
    { 318, "Sf" },
    { 322, "ffffff" },
...
static const std::pair<int, std::string> th13_fmts[] = {
    { 83, "" },
    { 85, "fff" },
    { 88, "fffff" },
    { 89, "fff" },
...
const std::string thecl_find_format(unsigned int version, unsigned int id,
    ...
    case 10:
        ...
        break;
    default:
        std::cerr << "thecl: unsupported version: " << version << "\n";
        return "NOTFOUND";
    }
