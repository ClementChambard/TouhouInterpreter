...
int Item::FUN_00434b80()
{
    if (item_type == 4 || item_type == 6 || item_type == 15 || item_type == 5 || item_type == 7) {
        ...
        vm->pos = position; // TODO: SHOULD BE ENTITY_POS
        vm->rotation.z = 0.0;
        vm->update();
        //vm->mode_of_create_child = 0;
        //AnmManager::insert_in_world_list_back(&local_8,vm);
        //if (item_type != 4 && item_type != 5) SoundManager::play_sound_centered(0x30);
        ...
        //vm->mode_of_create_child = 0;
        //AnmManager::insert_in_world_list_back(&local_8,vm);
        //if (appear_sound >= 0) SoundManager::play_sound_centered(appear_sound);
        return 0;
    }
    return 0;
}
