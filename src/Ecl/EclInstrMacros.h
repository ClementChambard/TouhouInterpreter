...
#define _notImpl NS_WARN("/!\\ %s is not implemented", __name.c_str());

#define _alert NS_WARN("/!\\ alert ---> %s has been used", __name.c_str());

#define _warn(m) NS_WARN("/!\\ warning at %s: %s", __name.c_str(), m);
