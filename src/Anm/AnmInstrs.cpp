...
int VM::exec_instruction(bytes ins) {
    ...
    switch (type) {
        ...
        case 128: // fatan
            ...
            break;
        case 129: // validAngle
            while (f(0) > ns::PI<f32>) rf(0) -= ns::PI_2<f32>;
            while (f(0) <= -ns::PI<f32>) rf(0) += ns::PI_2<f32>;
            break;
        case 130: // circlePos
            rf(0) = f(3) * ns::cos(f(2));
        ...
        case 407: // posTime
            ...
            break;
        case 408: // colorTime
            rgb1_i.start(ns::vec3(color_1.r, color_1.g, color_1.b), ns::vec3(S(2), S(3), S(4)), S(0), S(1));
            break;
        case 409: // alphaTime
        ...
        case 412: // scaleTime
            ...
            break;
        case 413: // color2Time
            rgb2_i.start(ns::vec3(color_2.r, color_2.g, color_2.b), ns::vec3(S(2), S(3), S(4)), S(0), S(1));
            break;
        case 414: // alpha2Time
        ...
        case 432: // ins_432
            ...
            break;
        case 433: // ins_433
            pos_i.start(bitflags.alt_pos ? __pos_2 : pos, { f(3)*ns::cos(f(2)), f(3)*ns::sin(f(2)), pos.z }, S(0), S(1));
            break;
        case 434: // scale2
            scale_2 = { f(0), f(1) };
            bitflags.scaled = true;
