...
int VM::check_val(int i) {
    ...
    else if (i == 10022) return static_cast<int>(ns::frand() * rand_param_int);
...
float VM::check_val(float f) {
    ...
    else if (f == 10010.f || f == 10030.f) return ns::frandm11() * rand_param_pi;
    else if (f == 10011.f || f == 10031.f) return ns::frand() * rand_param_one;
    else if (f == 10012.f || f == 10032.f) return ns::frandm11() * rand_param_one;
    else if (f == 10013.f) return pos.x;
    else if (f == 10014.f) return pos.y;
    else if (f == 10015.f) return pos.z;
    ...
    else if (f == 10022.f) return static_cast<int>(ns::frand() * rand_param_int);
    else if (f == 10023.f) return rotation.x;
    else if (f == 10024.f) return rotation.y;
    else if (f == 10025.f) return rotation.z;
